...
export default function FlavorCategoryClient({ flavor, flavorInfo, products }: FlavorCategoryClientProps) {
  ...
  // Get available strengths with counts for the Filter by Strength section
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              >
                <div className="text-center">
                  <div className="w-12 h-12 mx-auto mb-2 bg-gradient-to-br from-amber-400 to-brown-500 rounded-full flex items-center justify-center">
      ...
      <section className="py-6">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-amber-500 to-orange-500 text-white p-2 rounded-lg mb-4 text-center">
              <div className="flex items-center justify-center text-sm">
                <TrendingUp className="mr-1" size={16} />
                <span className="font-bold">Coffee Lovers' Choice:</span>
                <span className="ml-1">{filteredProducts.filter(p => p.inStock).length} coffee flavor products selling fast this week!</span>
              </div>
            </div>
            ...
            <div className="text-center mt-8 text-gray-600">
              Showing {filteredProducts.length} of {products.length} premium coffee flavor nicotine pouches
            </div>
          </div>
        </div>
      </section>
              ...
              {flavorInfo.benefits.map((benefit, index) => {
                ...
                return (
                  <div key={index} className="text-center p-6 bg-gray-50 rounded-2xl">
                    <IconComponent className="text-amber-600 mx-auto mb-4" size={32} />
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg">
                ...
                <p className="text-gray-600">
                  Our coffee flavor nicotine pouches offer authentic coffee and espresso taste profiles 
                  that provide a rich, satisfying experience perfect for coffee lovers seeking a tobacco-free alternative.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  What coffee varieties are available?
                </h3>
                <p className="text-gray-600">
                  We offer coffee nicotine pouches in classic Coffee and bold Espresso flavors, 
