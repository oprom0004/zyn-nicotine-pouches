    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Nicotine Pouch Not Found</h1>
          <p className="text-gray-600 mb-8">The nicotine pouch you're looking for doesn't exist.</p>
