...
export default function EspressoFlavorCategoryClient({ flavor, flavorInfo, products }: FlavorCategoryClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="py-4 bg-gradient-to-br from-white to-stone-50">
      ...
      {/* Espresso Navigation - Return to Coffee Flavors */}
      <section className="py-3 bg-gradient-to-r from-stone-50 to-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              <Link 
                ...
                className="mb-3 md:mb-0 inline-flex items-center px-4 py-2 bg-white rounded-lg border-2 border-stone-200 hover:border-stone-300 transition-all duration-300 hover:scale-105 group"
              >
                <span className="text-xl mr-2">☕</span>
                <div>
                  <div className="font-medium text-gray-900 group-hover:text-stone-700">← Back to All Coffee Flavors</div>
              ...
              <Link 
                ...
                className="inline-flex items-center px-4 py-2 bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg border-2 border-amber-200 hover:border-amber-300 transition-all duration-300 hover:scale-105 group"
              >
                <span className="text-xl mr-2">☕</span>
                <div>
                  <div className="font-medium text-gray-900 group-hover:text-amber-700">Try Coffee →</div>
                  <div className="text-xs text-gray-500">Rich & smooth flavor</div>
                </div>
              </Link>
            </div>
          </div>
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className={`px-3 py-1 rounded-full text-xs font-medium transition-colors ${
                  !selectedStrength ? 'bg-stone-600 text-white' : 'bg-white text-gray-700 border hover:bg-gray-50'
                }`}
              >
                All Strengths
              </button>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-wrap justify-between items-center mb-6 p-4 bg-white rounded-xl shadow-sm">
              ...
              <select 
                ...
                className="px-3 py-1.5 rounded-lg border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-stone-500"
              >
            ...
            <div className="text-center text-gray-600">
              <p>Showing {filteredProducts.length} of {products.length} espresso flavor nicotine pouches</p>
              {selectedStrength && (
                <p className="mt-2 text-sm">
                  Filtered by: <span className="font-medium text-stone-600">{selectedStrength} strength</span>
                </p>
              )}
            </div>
          </div>
