      ...
      <section className="py-4 bg-gradient-to-br from-white to-stone-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Connection to Coffee Flavors */}
            <div className="mb-4 p-3 bg-stone-100 rounded-lg">
              <p className="text-sm text-stone-800">
                <span className="font-medium">Part of our Coffee Collection:</span> 
                <Link href="/coffee-flavors-nicotine-pouches" className="ml-1 underline hover:text-stone-600">
                  Explore all coffee flavors including Coffee & Espresso →
                </Link>
              </p>
            </div>
