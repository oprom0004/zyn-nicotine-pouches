...
export default function FlavorCategoryClient({ flavor, flavorInfo, products }: FlavorCategoryClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-4 bg-gradient-to-br from-white to-green-50">
      ...
      <section className="py-6">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white p-2 rounded-lg mb-4 text-center">
              <div className="flex items-center justify-center text-sm">
                <TrendingUp className="mr-1" size={16} />
                <span className="font-bold">High Demand:</span>
                <span className="ml-1">{filteredProducts.filter(p => p.inStock).length} wintergreen products selling fast this week!</span>
              </div>
            </div>
            ...
            <div className="text-center mt-8 text-gray-600">
              Showing {filteredProducts.length} of {products.length} premium wintergreen nicotine pouches
            </div>
