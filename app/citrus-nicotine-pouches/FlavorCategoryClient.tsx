...
export default function CitrusFlavorCategoryClient({ flavor, flavorInfo, products }: FlavorCategoryClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Citrus Navigation - Return to Citrus Flavors */}
      <section className="py-3 bg-gradient-to-r from-orange-50 to-yellow-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between">
              {/* Back to Citrus Flavors */}
              <Link 
                href="/citrus-flavors-nicotine-pouches"
                className="mb-3 md:mb-0 inline-flex items-center px-4 py-2 bg-white rounded-lg border-2 border-orange-200 hover:border-orange-300 transition-all duration-300 hover:scale-105 group"
              >
                <span className="text-xl mr-2">🍊</span>
                <div>
                  <div className="font-medium text-gray-900 group-hover:text-orange-700">← Back to All Citrus Flavors</div>
                  <div className="text-xs text-gray-500">Explore Citrus & Lemon varieties</div>
                </div>
              </Link>

              {/* Related Citrus Flavor */}
              <Link 
                href="/lemon-nicotine-pouches"
                className="inline-flex items-center px-4 py-2 bg-gradient-to-br from-yellow-50 to-amber-50 rounded-lg border-2 border-yellow-200 hover:border-yellow-300 transition-all duration-300 hover:scale-105 group"
              >
                <span className="text-xl mr-2">🍋</span>
                <div>
                  <div className="font-medium text-gray-900 group-hover:text-yellow-700">Try Lemon →</div>
                  <div className="text-xs text-gray-500">Bright & crisp flavor</div>
                </div>
              </Link>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-wrap justify-between items-center mb-6 p-4 bg-white rounded-xl shadow-sm">
              ...
              <select 
                ...
                className="px-3 py-1.5 rounded-lg border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
              >
            ...
            <div className="text-center text-gray-600">
              <p>Showing {filteredProducts.length} of {products.length} citrus flavor nicotine pouches</p>
              {selectedStrength && (
                <p className="mt-2 text-sm">
                  Filtered by: <span className="font-medium text-orange-600">{selectedStrength} strength</span>
                </p>
              )}
            </div>
          </div>
